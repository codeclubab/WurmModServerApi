...
public class CaveColors {
    ...
    static {
        addMapping(Tile.TILE_CAVE_WALL, Color.PINK.darker());
        addMapping(Tile.TILE_CAVE_WALL_REINFORCED, Color.PINK.darker().darker());
        ...
        addMapping(Tile.TILE_CAVE_WALL_ORE_LEAD, Color.DARK_GRAY);
